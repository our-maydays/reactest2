	...
	return (
		...
		{/*			color: '#372773',*/}
			...
			<div style={{
				...
				<div style={styles.parentname}> 노신조 </div>

				<div style={styles.type}> 의 아들</div>
				<div style={styles.name}> 경보 </div><br/>
			</div>
			...
			<div style={{
				...
				<div style={styles.separate}> · </div>
				<div style={styles.parentname}> 한현순 </div>

				<div style={styles.type}> 의 딸</div>
				<div style={styles.name}> 유진</div><br/>
			</div>
